...
target_url= ("http://archive.ics.uci.edu/ml/machine-learning-databases/breast-cancer-wisconsin/breast-cancer-wisconsin.data")
...
# filling missing values with mean bv
for i in range (2,10):
    for j in range(699):
        if d.iloc[j, i] == "?":
